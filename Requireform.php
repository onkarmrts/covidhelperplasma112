...
try 
{
    $conn = new PDO("mysql:host=$host;dbname=plasmadetails", $username, $password);
...
if(isset($_POST['save_contact']))
{
	//print_r($_POST);
	//print_r($_POST);
	$sql = "INSERT INTO plasmarequire(name, Address, user_email, number, BloodGroup, gender, date ) VALUES('".addslashes($_POST['name'])."', '".addslashes($_POST['Address'])."', '".addslashes($_POST['user_email'])."', '".addslashes($_POST['number'])."', '".addslashes($_POST['BloodGroup'])."', '".addslashes($_POST['gender'])."', '".addslashes($_POST['date'])."')";
	$conn->query($sql);
...
<div id="outside">
<form id="survey-form" action="Requireform.php" method="POST">
  <h1 id="title">Regestration Form for Plasma Required </h1>


  <p id="description"><b>Note:</b> Form is to be filled by those people who required plasma, also you can check the list of donors may you get their your required donor.</p>
